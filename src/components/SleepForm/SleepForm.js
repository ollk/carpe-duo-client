...
export default class SleepForm extends Component {
  ...
  renderSleepMessage(hasTasks) {
    return hasTasks ? 'WARNING: changing sleep times will reset task positions!'
      : 'Set your waking hours for the weekend'
  }

  renderButtonMessage(hasTasks) {
    return hasTasks ? 'Cancel' : 'Skip'
  }
  ...
  render() {
    ...
    return (
      ...
      <div className='sleep-box'>
        ...
        <p className='sleep-message'>
          {this.renderSleepMessage(this.state.hasTasks)}
        </p>
